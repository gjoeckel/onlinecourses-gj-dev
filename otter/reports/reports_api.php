...
// Check for local development first, then production fallback
...
if (!file_exists($master_includes_path) || !file_exists($db_file_path)) {
    error_log("Reports API Debug - Missing files: master_includes=" . $master_includes_path . ", db_file=" . $db_file_path);
    sendJsonError();
}
